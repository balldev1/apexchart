...
export const ScatterPage = () => {
    const [state, setState] = useState({
        series: [
            {
                ...
                data: [
                    ...
                    [16.4, 6.5], [10.9, 0], [24.5, 7.1], [10.9, 0], [8.1, 4.7], [19, 0], [21.7, 1.8],
            ...
            },
            {
                ...
                data: [
                    ...
                    [12.7, 11.8], [2.1, 10], [2.5, 10], [27.1, 10], [2.9, 11.5], [7.1, 10.8],
                    [2.1, 12]
                ]
            },
            {
                ...
                data: [
                    ...
                    [10.9, 3], [28, 4], [27.1, 0.3], [16.4, 4], [13.6, 0], [19, 5], [22.4, 3],
                    [24.5, 3], [32.6, 3], [27.1, 4], [29.6, 6], [31.6, 8], [21.6, 5], [20.9, 4],
                    [22.4, 0], [32.6, 10.3], [29.7, 20.8], [24.5, 0.8], [21.4, 0], [21.7, 6.9],
        ...
        options: {
            chart: {
                height: 350,
                type: "scatter", // ใช้ scatter แทน area
                zoom: {
                    enabled: true,
                    type: "xy"
                }
